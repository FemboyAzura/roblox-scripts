...
if not getgenv().settin then
	getgenv().settin = {
		['WebHook'] = {
			['Webhook'] = "https://discord.com/api/webhooks/1076325875299131402/AXKSFeA1fHvkP8bPxFLBd2-I98P0xkqcrh32-_slS-UN-Z5U1uwB-aFrFOtqVxtk2Blw",
		},
...
task.spawn(function()
	while true do
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="9"><font color= "#FFB300"><font face="DenkOne">💸         Win Big!         💸 ------💸-Azuras Robux Casino-💸 	💸          .help to play       💸</font></font></font></stroke>', "booth")
		task.wait(3)
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="9"><font color= "#FFB300"><font face="DenkOne">💸         Win Big!         💸 -----💸-Azuras Robux Casino-💸-  	💸          .help to play        💸</font></font></font></stroke>', "booth")
		task.wait(3)
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="9"><font color= "#FFB300"><font face="DenkOne">💸         Win Big!         💸 ----💸-Azuras Robux Casino-💸--  	💸          .help to play        💸</font></font></font></stroke>', "booth")
